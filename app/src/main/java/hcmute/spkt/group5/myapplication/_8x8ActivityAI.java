...
public class _8x8ActivityAI extends AppCompatActivity {
    ImageButton btnBack;    // Button use for back to ChooseOptionActivity
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_8x8_ai);

        btnBack = (ImageButton) findViewById(R.id.btn_back);
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(_8x8ActivityAI.this, MainActivity.class);
